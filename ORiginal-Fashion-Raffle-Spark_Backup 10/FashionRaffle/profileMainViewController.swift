...
class profileMainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let backgroundPic = Profile.currentUser?.backgroundPicture{
            self.profileBackground.image = backgroundPic
        }
        else {
    ...
    */
    ...
    func uploadProfileImage(){
        ...
        Profile.currentUser?.backgroundPicture = self.profileBackground.image
